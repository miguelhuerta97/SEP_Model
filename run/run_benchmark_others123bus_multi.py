...
if __name__ == '__main__':
	...
	OFOL = '../experiments/123bus_factor2_benchmark_others_4hourssteps'
	if not exists(OFOL):
		makedirs(OFOL)
	...
	kwargs = {'kyri': True, 'noctrl': True} #'ieee1547': True
	l_processes = []
	count = 0
	for hour in range(6):
		TIME_CONFIG = {
			'tini': datetime(2018, 7, 27, 0, 0, 0),
			'tiniout': datetime(2018, 8, 15, hour*4, 0, 0),
			'tend': datetime(2018, 8, 15, hour*4 + 3, 59, 54),
